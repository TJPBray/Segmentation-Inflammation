...
%Modification of uNetLayers to include DiceLoss
% Tim Bray July 2022
%t.bray@ucl.ac.uk
...
%          DAGNetwork, semanticseg, pixelLabelImageDatastore,
...
pixelClassLayer = dicePixelClassificationLayer('Name','Segmentation-Layer with Dice Loss');
